    ...
    <div class="email-updates">
        ...
        <div class="email-info">
            <form action="" id="emailForm">
                <input type="text" name="name" id="name" class="info-input" placeholder="NAME" required>
                <input type="email" name="email" id="email" class="info-input" placeholder="EMAIL" required>
...
document.addEventListener("click", function (e) {
    const submit = e.target.closest(".send-btn");
    if (!submit) return;
